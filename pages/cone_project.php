<?php
// these values need to be configurable within the plugin
					...
					<form id="manage-project-clone" method="post" action="manage_proj_clone.php" class="form-inline">
						<fieldset>
							...
							<div><span class=form-inline>
								<input type="submit" name="copy_from" class="btn btn-sm btn-primary btn-white btn-round" value="<?php echo lang_get( 'Clone Project' ) ?>"/>
							</span></div>
						</fieldset>
					</form>
				</div>
